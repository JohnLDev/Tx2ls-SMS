...
import Forgot from '../../assets/forgot-password-logo.png'
import { Border, Button, Input, Label, Page, Title } from './styles'
import { toast } from 'react-toastify'
import api from '../../services/apiClient'

const RedefinePasswordEnterprisePage: React.FC = () => {
  ...
  async function HandleRedefinePassword(): Promise<void> {
    ...
    try {
      ...
      await api.patch('/user/redefine-password', data)
    } catch (error) {
  ...
  return (
    <Border>
      <Page id='login-page'>
        ...
        <div className='login'>
          <Title>Redefina Sua Senha Abaixo</Title>
...
export default RedefinePasswordEnterprisePage
